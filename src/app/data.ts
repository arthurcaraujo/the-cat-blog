export default [
    {
        date: new Date(),
        descriptionBrief: "That swinging, dangling pouch on your cat's belly is actually a normal structure found in all cats—wild and domestic. However, it's important to tell the difference between a normal pouch and a big fat pad associated with obesity.",
        descriptionDetailed: [
